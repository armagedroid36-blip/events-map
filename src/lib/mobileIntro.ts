 ...
 *  v2 (16.09.2026): в панели появился список «Ближайшие события», поэтому старый
 *  флаг v1 игнорируем — иначе у всех, кто когда-то закрыл панель, новое
 *  содержимое не показалось бы вообще. */
export const HOME_PANEL_KEY = 'home_panel_dismissed_v2';
...
export const SEO_BLOCK_SELECTOR =
  ...
  '#seo-city-archive, #seo-category-archive';
