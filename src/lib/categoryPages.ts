...
/** Порог качества: страница ячейки существует, только если в городе
 *  >= 3 АКТИВНЫХ события этой категории (набор list_active_events). Ячейки с
 *  1–2 событиями — тонкие страницы: их нет физически, они вне sitemap, а SPA
 *  отдаёт существующую 404-заглушку (снижение порога до 1 дало 26 таких
 *  страниц в индексе — «Crawled — currently not indexed»). */
