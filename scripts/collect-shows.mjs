// ВНИМАНИЕ: шаг снят с пайплайна (collect-events.yml) — его 4 карточки
// (Tata Show, Once Show, Charming Danang, Ao Dai Show) перенесены в SEEDS
// scripts/collect-theatres.mjs и теперь поддерживаются самообходом источников.
// Файл оставлен как справка/аварийный ручной запуск.
//
